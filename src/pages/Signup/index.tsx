            ...
            <div className="w-full max-w-md overflow-hidden flex flex-col justify-center">
              <div className="flex flex-col mb-5.5 relative">
                ...
                <input
                  ...
                  className="text-gray-400 border-1 border-solid border-gray-100/20 rounded-md pt-2 pb-2 pl-12 focus:border-green-100/40 outline-none"
                  value={userName}
              ...
              <div className="flex flex-col items-center">
                <button
                  className="w-full bg-[#6f5af59a] rounded-lg p-2 mt-4.5 cursor-pointer text-[#020817] hover:bg-[#6F5AF5] duration-700 ease-in-out"
                  onClick={() => newUser()}
                >
                  Criar Conta
                </button>
                <Link to={"/login"} className="text-[#6F5AF5] mt-15">
